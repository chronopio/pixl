...
// Is responsible for creating a renderer for the `PxCanvas` widget.
...
// Is used to convert the mouse event coordinates to the corresponding canvas pixel coordinates.
