...
// Is responsible for updating the visual representation of the swatch
// based on the current state of the parent object.
func (renderer *SwatchRenderer) Refresh() {
	...
	if renderer.parent.Selected {
		renderer.square.StrokeColor = color.NRGBA{0, 0, 0, 0}
